                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-inner">
                                    ...
                                    <hr>
                                    <form class="form-element p-2" id="internalTransferForm" name="internalTransferForm">
                                        @csrf
                                            ...
                                            <div class="col-md-6">
                                                <div class="fancy-border">
                                                    <div class="form-group">
                                                        <label class="form-label" for="amount">Enter Email Address</label>
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="email"
                                                                id="email" value="" placeholder="ex - John@gmail.com">
                                            ...
                                            <div class="col-md-5 offset-md-1">
                                                ...
                                                <div class="card badge-dim badge-info mt-1">
                                                    <div class="card-inner d-flex justify-content-between fw-bold h6">
                                                        <span class="w-40 text-dark">Your Wallet Balance</span>
                                                        <span>=</span>
                                                ...
                                                <div class="card badge-dim badge-info mt-1">
                                                    <div class="card-inner d-flex justify-content-between fw-bold h6">
                                                        <span class="w-40 text-dark">Min transfer limit</span>
                                                        <span>=</span>
                                                        <span class="w-40 text-right text-dark"
                                                            id="">{{ $min_internal_transfer }}</span>
                                                    </div>
                                                </div>

                                                <div class="card badge-dim badge-info mt-1">
                                                    <div class="card-inner d-flex justify-content-between fw-bold h6">
                                                        <span class="w-40 text-dark">Max transfer limit</span>
                                                        <span>=</span>
                                                        <span class="w-40 text-right text-dark"
                                                            id="">No limit</span>
                                                    </div>
                                ...
                                <div class="card-inner-group">
                                    <div class="card-inner position-relative card-tools-toggle pb-3 pt-3">
                                        <div class="card-title-group">
                                            <div class="card-title">
                                                <h6 class="title">Internal Transfer History</h6>
                                            </div>
                                            <!--card-title-->
                                        </div>
                                        <!--card-title-group-->
                                    ...
                                    <div class="card-inner">
                                        <div class="">
                                            ...
                                            <table id="internalTransferHistory"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="nk-tb-col">To/From User</th>
...
$(document).ready(function() {
    simple = $('#internalTransferHistory').DataTable({
        ...
        "responsive": true,
        "ajax": {
            "url": "{{ route('user.internalTransferHistory') }}",
            "type": "POST",
            "data": function(d) {
                d._token = '{{csrf_token()}}',
                    d.type = ''
...
$("body").on("click", "#transferBtn", function() {
    ...
    $.ajax({
        beforeSubmit: function() {
            $("#transferBtn").attr('disabled', 'disabled').html('Please wait...');
        },
        type: 'POST',
        url: "{{ route('user.internalTransfer') }}",
        data: {
            _token: '{{csrf_token()}}',
            email: email,
            amount: amount,
        ...
        success: function(response) {
            if (response.R) {
                ...
                if ('data' in response && 'wallet_amount' in response.data) {
                    $("#wallet_amount").html(response.data
                        .wallet_amount);
                }
                reload_table();
