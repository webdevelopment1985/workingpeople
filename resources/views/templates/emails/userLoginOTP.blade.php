    ...
    <center style="width: 100%; height: 100%; background-color: #fff;">
        <div style="max-width: 600px; margin: 0 auto;">
            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                style="margin: auto; background-color:#F5F6FA">
                            ...
                            <tr>
                                <td style="text-align:center;">
                                    <a href="{{url('/')}}" target="_blank"><img
                                            ...
                                            style="width: 100px;margin: 8px;" /></a>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td class="no-padd" valign="top" style="padding: 20px 20px;">
                        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0"
                            width="100%" style="margin: auto; background-color:#fff">
                            <tr>
                                <td>
                                    <div class="mob-col-padding" style="padding: 2em; text-align: center;">
                                        <h2 class="mob-title1"
                                            style="margin-top:5px; margin-bottom: 18px; font-size: 18px; font-weight: 700; line-height: 28px; color:#000000; font-family: 'Inter', sans-serif;">
                                            Hi,
                                        </h2>
                                        <p
                                            style="color: #A3A3A3; font-weight: 500; line-height: 24px; font-size: 14px; margin:0px; padding:0px 0px 20px 0px; font-family: 'Inter', sans-serif;">
                                            Your one time password for user login is below :
                                        </p>
                                        <div class="otpborder"
                                            style="max-width: 400px; font-family: 'Inter', sans-serif; margin:0px auto 20px; border: 2px dashed #E4E4E4; color: #fff; text-align: center; padding:20px 30px; border-radius: 5px;">
                                            <h3
                                                style="font-weight: 600; line-height: normal; font-size: 18px; color: #179B11; margin:0 0 0 0;">
                                                OTP : {{ $token }}
                                            </h3>
                                        </div>
                                        ...
                                        <!-- <p
                                            style="font-family: 'Inter', sans-serif; color: #A3A3A3; line-height: 24px; font-size: 14px; margin:0px; font-weight: 500; padding:0px 0px 20px 0px;">
                                        ...
                                        <p
                                            style="color: #A3A3A3; font-size: 14px; margin:0px; line-height: 24px; font-weight: 500; padding:0px 0px 0px 0px; font-family: 'Inter', sans-serif;">
                                            Thank you<br />
                                            <strong
                                                style="color: #000; font-size: 16px; margin:0px; line-height: 24px; font-weight: 600; font-family: 'Inter', sans-serif;">{{env('APP_NAME')}}
                                                WorkingPeople Team</strong>
                                        </p>
                                    </div>
                                </td>
                            </tr>
                                        ...
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <a href="mailto:{{env('MAIL_FROM_ADDRESS')}}"
                                                    style="text-decoration: none; color: #000; margin:0px; font-size: 14px; font-weight: 500;">{{env('MAIL_FROM_ADDRESS')}}</a>
